    ...
    <div className="flex app-container" style={{ minHeight: '100vh', width: '100%', position: 'relative' }}>
      ...
      <div className="mobile-top-header">
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="QuantStakes Logo" style={{ height: '24px', objectFit: 'contain' }} />
        </div>
      ...
      return (
        <div style={{height: '100vh', width: '100%', background: 'var(--bg-dark)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
          <div className="flex items-center gap-3 mb-10">
            <img src="/logo.png" alt="QuantStakes Logo" className="brand-logo-animated" style={{ height: '48px', objectFit: 'contain' }} />
          </div>
