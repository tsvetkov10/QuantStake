    ...
    <div className="flex-col" style={{ minHeight: '100vh', width: '100vw', backgroundColor: 'var(--bg-dark)' }}>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', paddingTop: '10rem', paddingBottom: '4rem' }}>
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-gradient" style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0 }}>QuantStake Terms of Service</h1>
        </div>
        ...
        <div className="glass-panel text-secondary" style={{ lineHeight: '1.8' }}>
          ...
          <p style={{ marginBottom: '1.5rem' }}>By accessing or using the QuantStake analytics terminal ("Service"), you agree to be bound by these Terms of Service. If you disagree with any part of the terms, you do not have permission to access the Service.</p>
          
          <h3 style={{ color: 'var(--text-primary)', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '2rem' }}>2. Description of Service</h3>
          <p style={{ marginBottom: '1.5rem' }}>QuantStake provides portfolio management, data visualization, and AI-driven parsing tools for sports betting analytics. We are strictly a software provider. We do not accept wagers, host gambling operations, or facilitate financial transactions related to sports betting.</p>
          
          <h3 style={{ color: 'var(--text-primary)', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '2rem' }}>3. User Accounts</h3>
          <p style={{ marginBottom: '1.5rem' }}>When you create an account, you must provide accurate and complete information. You are solely responsible for maintaining the confidentiality of your account and password. QuantStake reserves the right to terminate accounts that violate our terms or engage in abusive behavior.</p>

          <h3 style={{ color: 'var(--text-primary)', fontSize: '1.2rem', marginBottom: '1rem', marginTop: '2rem' }}>4. Disclaimer of Liability</h3>
          <p style={{ marginBottom: '1.5rem' }}>The information provided by QuantStake is for analytical and entertainment purposes only. We do not guarantee profits. Sports betting involves significant financial risk. QuantStake is not liable for any financial losses incurred based on the data or insights provided by our terminal.</p>
        </div>
      </div>
    </div>
  );
