    ...
    <div className="flex-col" style={{ minHeight: '100vh', width: '100vw', backgroundColor: 'var(--bg-dark)' }}>
      ...
      <div className="container" style={{ maxWidth: '800px', margin: '0 auto', paddingTop: '10rem', paddingBottom: '4rem' }}>
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-gradient" style={{ fontSize: '2rem', fontWeight: 'bold', margin: 0 }}>QuantStake Privacy Policy</h1>
        </div>
        ...
        <div className="glass-panel text-secondary" style={{ lineHeight: '1.8' }}>
          ...
          <p style={{ marginBottom: '1.5rem' }}>Your privacy is critically important to us. At QuantStake, we have a few fundamental principles:</p>
