      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem', paddingBottom: '1rem', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#fff', margin: 0, letterSpacing: '-0.5px', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            Profile <span style={{ background: 'linear-gradient(90deg, #a78bfa, #a13bf7)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Settings</span>
          </h1>
          ...
          <div style={{ 
            ...
            <div style={{ width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <span style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', padding: '0.3rem 0.75rem', borderRadius: '20px', fontSize: '0.7rem', fontWeight: '800', color: '#ccc', letterSpacing: '1px', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                <User size={12} color="#a78bfa" /> Public ID
              </span>
              <span style={{ 
                background: isAnalyst ? 'rgba(161, 59, 247, 0.15)' : 'rgba(167, 139, 250, 0.15)', 
                border: isAnalyst ? '1px solid rgba(161, 59, 247, 0.3)' : '1px solid rgba(167, 139, 250, 0.3)', 
                color: isAnalyst ? '#a13bf7' : '#a78bfa', 
            ...
            <div style={{ position: 'relative', marginBottom: '1.25rem' }}>
              <div style={{ 
                ...
                fontWeight: '300', 
                overflow: 'hidden', 
                boxShadow: isAnalyst ? '0 0 25px rgba(161, 59, 247, 0.25)' : '0 0 25px rgba(167, 139, 250, 0.2)',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem', width: '100%', background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '0.85rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', borderLeft: '1px solid rgba(255,255,255,0.08)' }}>
                ...
                <span style={{ fontSize: '1.4rem', fontWeight: '600', color: '#a78bfa', marginTop: '0.2rem', textShadow: '0 0 10px rgba(167, 139, 250,0.3)' }}>{winRate}%</span>
              </div>
            </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', flex: 1 }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', borderBottom: '1px solid rgba(255,255,255,0.06)', paddingBottom: '1rem' }}>
              <div style={{ padding: '0.6rem', background: 'rgba(167, 139, 250, 0.1)', border: '1px solid rgba(167, 139, 250, 0.2)', borderRadius: '12px', color: '#a78bfa' }}>
                <User size={20} />
              </div>
              <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <input 
                ...
                onFocus={e => { e.target.style.borderColor = '#a78bfa'; e.target.style.boxShadow = '0 0 0 3px rgba(167, 139, 250, 0.15), inset 0 2px 8px rgba(0,0,0,0.5)'; }}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem' }}>
              ...
              <div 
                ...
                style={{ 
                  padding: '1.5rem', 
                  borderRadius: '18px', 
                  background: !isAnalyst ? 'linear-gradient(135deg, rgba(167, 139, 250, 0.08), rgba(0, 0, 0, 0.4))' : 'rgba(255,255,255,0.02)', 
                  border: !isAnalyst ? '1px solid rgba(167, 139, 250, 0.4)' : '1px solid rgba(255,255,255,0.08)', 
                  cursor: 'pointer', 
                  transition: 'all 0.3s cubic-bezier(0.16, 1, 0.3, 1)',
                  boxShadow: !isAnalyst ? '0 8px 25px rgba(167, 139, 250, 0.15)' : 'none',
                  display: 'flex',
                  flexDirection: 'column',
              ...
              >
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem' }}>
                      <div style={{ padding: '0.5rem', background: !isAnalyst ? 'rgba(167, 139, 250,0.1)' : 'rgba(255,255,255,0.05)', borderRadius: '10px', color: !isAnalyst ? '#a78bfa' : 'rgba(255,255,255,0.4)' }}>
                        <Activity size={18} />
                      </div>
                ...
                <div style={{ paddingTop: '0.75rem', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  ...
                  <span style={{ 
                    ...
                    borderRadius: '20px', 
                    background: !isAnalyst ? '#a78bfa' : 'rgba(255,255,255,0.05)', 
