...
export default function Onboarding({ session, onComplete }) {
  ...
  return (
    <div className="flex items-center justify-center" style={{ minHeight: '100vh', width: '100vw' }}>
      <div className="glass-panel" style={{ width: '100%', maxWidth: '500px', padding: '3rem' }}>
        <div className="flex-col items-center justify-center mb-8">
          <div style={{ background: 'rgba(0, 243, 255, 0.1)', padding: '1.5rem', borderRadius: '50%', marginBottom: '1rem', boxShadow: 'var(--glow-cyan)' }}>
