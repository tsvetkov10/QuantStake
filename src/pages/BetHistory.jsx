            ...
            return (
              ...
              >
                ...
                <div style={{ marginTop: 'auto', paddingTop: '6px', borderTop: '1px dashed rgba(255, 255, 255, 0.1)', display: 'flex', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.6rem', color: '#9d8df0', fontFamily: 'monospace', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold' }}>{market}</span>
                </div>
              </div>
            );
          }
        ...
        >
          <div 
            ...
            style={{ 
              ...
              boxShadow: '0 10px 40px rgba(72, 51, 181, 0.2)',
              display: 'flex',
              alignItems: 'start',
              gap: '12px',
              borderRadius: '12px',
          ...
          >
            <div style={{ background: 'rgba(72, 51, 181, 0.1)', padding: '8px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div className="flex justify-between items-end flex-wrap gap-6">
        ...
        <button 
          ...
          style={{
            ...
            height: 'auto',
            background: 'rgba(72, 51, 181, 0.03)',
            border: '1.5px solid rgba(72, 51, 181, 0.3)',
            color: 'var(--text-primary)',
            boxShadow: '0 0 10px rgba(72, 51, 181, 0.1)',
            cursor: 'pointer',
            transition: 'all 0.2s'
          }}
          onMouseEnter={e => { e.currentTarget.style.background = 'rgba(72, 51, 181, 0.1)'; e.currentTarget.style.boxShadow = '0 0 15px rgba(72, 51, 181, 0.2)'; }}
          onMouseLeave={e => { e.currentTarget.style.background = 'rgba(72, 51, 181, 0.03)'; e.currentTarget.style.boxShadow = '0 0 10px rgba(72, 51, 181, 0.1)'; }}
        >
          ...
          <div className="flex items-center gap-4 flex-wrap">
            ...
            <div className="flex items-center gap-1.5 p-1 rounded-lg" style={{ background: 'var(--adaptive-white-02)', border: '1px solid var(--border-glass)' }}>
              <button 
                ...
                style={{
                  background: viewMode === 'slips' ? 'rgba(72, 51, 181,0.08)' : 'transparent',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '0.35rem',
                  cursor: 'pointer',
              ...
              <button 
                ...
                style={{
                  background: viewMode === 'rows' ? 'rgba(72, 51, 181,0.08)' : 'transparent',
                  border: 'none',
                  borderRadius: '6px',
                  padding: '0.35rem',
                  cursor: 'pointer',
          ...
          {sportsList.map(sp => (
            <button
              ...
              style={{
                ...
                borderRadius: '20px',
                cursor: 'pointer',
                background: selectedSport === sp ? 'rgba(72, 51, 181, 0.1)' : 'var(--adaptive-white-02)',
                    ...
                    >
                      ...
                      <td style={{ padding: '1.25rem 1.5rem' }}>
                        <span style={{ 
                          ...
                          borderRadius: '8px', 
                          background: bet.sport === 'Football' ? 'rgba(72, 51, 181, 0.05)' : 'var(--adaptive-white-03)', 
                          border: `1px solid ${bet.sport === 'Football' ? 'rgba(72, 51, 181, 0.15)' : 'var(--adaptive-white-05)'}`,
                          fontSize: '0.8rem',
                      ...
                      <td style={{ padding: '1.25rem 1.5rem', textAlign: 'center' }}>
                        <span style={{
                          ...
                          backgroundColor: bet.status === 'Won' ? 'rgba(16, 185, 129, 0.08)' : 
                                           ...
                                           bet.status === 'Cashed Out' ? 'rgba(255, 215, 0, 0.08)' : 'rgba(72, 51, 181, 0.08)',
                          ...
                          border: `1.5px solid ${
                            ...
                            bet.status === 'Cashed Out' ? 'rgba(255, 215, 0, 0.2)' : 'rgba(72, 51, 181, 0.2)'
                          }`,
                          fontWeight: '700',
                ...
                <div className="flex-col gap-3" style={{ fontSize: '0.8rem', display: 'flex', flex: 1 }}>
                  ...
                  <div style={{ background: 'rgba(0, 0, 0, 0.3)', borderRadius: '14px', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '0.85rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <span style={{ fontSize: '1.05rem', color: '#9d8df0', fontWeight: '700', fontFamily: 'monospace' }}>@{Number(bet.odds).toFixed(2)}</span>
                    </div>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      width: '100%',
                      padding: '0.65rem',
                      background: 'rgba(72, 51, 181, 0.06)',
                      border: '1px solid rgba(72, 51, 181, 0.2)',
                      borderRadius: '10px',
                      color: '#9d8df0',
                      fontSize: '0.8rem',
                      fontWeight: '700',
                    ...
                    onMouseEnter={e => { e.currentTarget.style.background = 'rgba(72, 51, 181, 0.15)'; e.currentTarget.style.borderColor = 'rgba(72, 51, 181, 0.4)'; }}
                    onMouseLeave={e => { e.currentTarget.style.background = 'rgba(72, 51, 181, 0.06)'; e.currentTarget.style.borderColor = 'rgba(72, 51, 181, 0.2)'; }}
                  >
                    <Copy size={14} />
                    <span>Copy Slip</span>
                  </button>
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: selectedBet.status === st ? 
                                          (st === 'Won' ? 'rgba(16, 185, 129, 0.15)' : st === 'Lost' ? 'rgba(239, 68, 68, 0.15)' : 'rgba(72, 51, 181, 0.15)') : 
                ...
                >
                  ...
                  <div className="flex-col gap-3" style={{ fontSize: '0.8rem' }}>
                    ...
                    <div style={{ background: 'rgba(0, 0, 0, 0.3)', borderRadius: '14px', border: '1px solid rgba(255, 255, 255, 0.08)', padding: '0.85rem 1rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: '0.8rem', color: 'rgba(255, 255, 255, 0.5)' }}>Odds</span>
                        <span style={{ fontSize: '1.05rem', color: '#9d8df0', fontWeight: '700', fontFamily: 'monospace' }}>@{Number(selectedBet.odds).toFixed(2)}</span>
                      </div>
                      <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.06)', paddingTop: '0.6rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <span style={{ fontSize: '0.8rem', fontWeight: '600', color: 'rgba(255, 255, 255, 0.7)' }}>Est. Return</span>
