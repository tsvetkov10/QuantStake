          ...
          <div className="glass-panel" style={{ padding: '2rem' }}>
            ...
            <form onSubmit={handleSubmit} className="flex-col gap-5">
              ...
              <button 
                ...
                onMouseEnter={e => { e.currentTarget.style.background = 'rgba(212, 175, 55, 0.15)'; e.currentTarget.style.borderColor = 'rgba(212, 175, 55, 0.5)'; e.currentTarget.style.boxShadow = '0 0 15px rgba(212, 175, 55, 0.2)'; }}
                onMouseLeave={e => { e.currentTarget.style.background = 'rgba(212, 175, 55, 0.05)'; e.currentTarget.style.borderColor = 'var(--border-glass)'; e.currentTarget.style.boxShadow = '0 0 10px transparent'; }}
              >
