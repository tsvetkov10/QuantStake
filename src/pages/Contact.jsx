    ...
    <div className="flex-col" style={{ minHeight: '100vh', width: '100%', padding: '4rem 2rem' }}>
      <div className="container" style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div className="grid grid-cols-2 gap-8" style={{ alignItems: 'flex-start' }}>
          ...
          <div className="glass-panel" style={{ background: 'rgba(10, 10, 16, 0.85)', border: '1px solid rgba(72, 51, 181, 0.15)', borderRadius: '24px', padding: '2.5rem', boxShadow: '0 20px 50px rgba(0, 0, 0, 0.6)' }}>
            {sent ? (
